    ...
    return (
        ...
        >
            {type === "text" ? (
                ...
                <div className={`relative ${isInDropArea ? "w-[70px] h-[70px]" : "w-[160px] h-[200px]"}`}>
                    <img src={content} alt={alt} style={{ objectFit: "contain", width: "100%", height: "100%" }} />
                </div>
            )}
        </div>
    );
            ...
            setDropAreas((areas) => {
                ...
                if (sourceAreaIndex !== -1) {
                    ...
                    newAreas[targetAreaIndex].items =
                        newAreas[targetAreaIndex].type === "single" ? [movedItem!] : [...newAreas[targetAreaIndex].items, movedItem!];
                } else {
                    ...
                    return (
                        <Card key={groupIndex} className="rounded-xl overflow-hidden">
                            <CardContent className="p-6 bg-green-50">
                                ...
                                <DroppableArea id={dropAreas[groupIndex]?.id} items={dropAreas[groupIndex]?.items} onDrop={handleDrop} />
                            </CardContent>
                        </Card>
                    );
                })}
                            ...
                            <div>
                                <CardContent className="p-6">
                                    <div className="grid grid-cols-4 gap-6">
                                        <div className="space-y-4 col-span-3">{renderExerciseContent()}</div>
                                            ...
                                            <Alert className="bg-blue-100 border-blue-500 text-blue-800 rounded-lg">
                                                ...
                                                <AlertDescription className="text-lg">
                                                    {exercise.is_instant_scored
                                                        ? `You scored ${score ?? 0} out of ${exercise.max_score} (${(
                                                              ((score ?? 0) / exercise.max_score) *
                                                              100
                                                          ).toFixed(2)}%)`
