...
const useAuthStore = create<AuthState>(
    (persist as AuthPersist)(
        (set, get) => ({
            ...
            login: async (email, password) => {
                try {
                    const response = await fetch(
                        BACKEND_API_URL + "/auth/loginTeacher",
                        {
                            method: "POST",
                            headers: {
            ...
            // Register action
            register: async (name, email, password, school, profilePicture?) => {
                try {
                    const response = await fetch(
                        BACKEND_API_URL + "/auth/registerTeacher",
                        {
                            method: "POST",
                            headers: {
                                "Content-Type": "application/json",
            ...
            logout: () => {
                ...
                // TODO: Clear out all other stores
